...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, video_length=None, moment_idx=None, msrc=None, mpos=None, mmask=None,
        ...
        if self.args.cross_cal_type == 'random_walk':
            ...
            saved_multi_modal_rep = t2v_src.clone().detach()
        ...
        return hs, references, memory_local, memory_global, attn_weights, mmemory_moment, nmmemory_moment, mmemory_frames, nmmemory_frames,saved_multi_modal_rep
