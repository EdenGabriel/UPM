...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, video_length=None):
        ...
        saved_multi_modal_rep = src.clone().detach()
        saved_multi_modal_rep = saved_multi_modal_rep[:video_length]
        ...
        return hs, references, memory_local, memory_global,saved_multi_modal_rep
